...
const formSchema = z.object({
    name: z.string().min(1, { message: "Nme is required" }),
    ...
    return (
        <div className="flex flex-col gap-6">
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <p className="text text-muted-foreground text-balance">
                                        Create your account
                                    </p>
                                </div>
                                ...
                                <div className="text-center text-sm">
                                    ...
                                    <Link href="/sign-in" className="underline unserline-offset-4">
                                        Sign-in
                                    </Link>
                                </div>
            ...
            text-balance *[a]:underline *[a]:underline-offset-4">
                By clicking continue, you agree to our <a href="#">Trems of Service</a> and <a href="#"> Provacy Policy</a>
            </div>
